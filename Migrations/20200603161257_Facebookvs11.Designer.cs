...
namespace Facebook.Migrations
{
    ...
    [Migration("20200603161257_Facebookvs11")]
    partial class Facebookvs11
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facebook.Models.Friend", b =>
                {
                    ...
                    b.Property<int?>("FriendUser1UserId");

                    b.Property<int?>("FriendUser2UserId");

                    b.HasKey("Id");

                    b.HasIndex("FriendUser1UserId");

                    b.HasIndex("FriendUser2UserId");
            ...
            modelBuilder.Entity("Facebook.Models.Friend", b =>
                {
                    b.HasOne("Facebook.Models.User", "FriendUser1")
                        .WithMany()
                        .HasForeignKey("FriendUser1UserId");

                    b.HasOne("Facebook.Models.User", "FriendUser2")
                        .WithMany()
                        .HasForeignKey("FriendUser2UserId");
                });
